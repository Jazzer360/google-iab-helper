...
public class SimplePurchaseStateFragment extends PurchaseStateFragment {
    ...
    public interface PurchaseStateListener {
         ...
         *
         * @param productId the product ID of the product whose purchase state changed
         * @param state     the new purchase state of the product
         */
     ...
     * @param type      type of product (either
